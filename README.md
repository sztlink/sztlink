...
- **Finding evidence is not using evidence** — long-context quality probes where the right chunk is present but does not drive the answer.  
  Start here: [`turboquant-cuda-bench/06-publicable/longctx/evidence-path`](https://github.com/sztlink/turboquant-cuda-bench/tree/main/06-publicable/longctx/evidence-path)

- **Machine Dream / Sonho da Máquina** — a public protocol for memory, archive, dreaming, and prospective replay in a personal cognitive implant.  
  Repo: [`machine-dream-research`](https://github.com/sztlink/machine-dream-research)

- **pi-ensemble** — a file-based coordination ledger for parallel coding agents.  
